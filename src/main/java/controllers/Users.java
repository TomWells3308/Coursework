...
public class Users {
    ...
    public String userGet(@PathParam("userID") Integer userID) {
        System.out.println("Invoked Users.userGetUserID()");
        ...
        try {
            ...
            while (results.next()) {
                ...
                row.put("StartDate", results.getDate(5));
                row.put("Activity", results.getBoolean(6));
                row.put("Token", results.getString(7));
            }
